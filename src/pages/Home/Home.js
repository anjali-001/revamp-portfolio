  ...
  return (
    <div className="home">
      ...
      <div className="home-content">
        ...
        <h3>Open source</h3>
        <p>As someone who has constantly learnt from open source, it feels good to be able to contribute to projects that is used by someone. My recent contribution,</p>
        <p>
